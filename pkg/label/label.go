...
func (l *Label) Buf() []uint16  { return l.buf }
func (l *Label) W() int16       { return l.w }
func (l *Label) H() int16       { return l.h }
...
func (l *Label) rgbaTo565(c color.RGBA) uint16 {
	r, g, b, _ := c.RGBA()
