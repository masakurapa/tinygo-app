...
func (*tinyDisplay) Size() (x, y int16) {
	return display.Size()
}

func (*tinyDisplay) SetPixel(x, y int16, c color.RGBA) {
	display.SetPixel(x, y, c)
}

func (*tinyDisplay) Display() error {
...
// 画面の傾きはサポート外
func CalibrateAccel()    {}
func AccelX() float64    { return 0 }
func AccelY() float64    { return 0 }
func AccelZ() float64    { return 0 }
